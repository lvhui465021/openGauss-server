...
has_5820 int;
BEGIN
    select count(*) from pg_catalog.pg_type where typname = 'hash16' limit 1 into has_hash16;
    select count(*) from pg_catalog.pg_proc where oid = 5820 limit 1 into has_5820;
...
BEGIN
    select count(*) from pg_catalog.pg_type where typname = 'hash16' limit 1 into has_hash16;
    select count(*) from pg_catalog.pg_proc where oid = 5819 limit 1 into has_5819;
